...
import {Animated, Dimensions, Image,TouchableOpacity, StyleSheet, ScrollView } from 'react-native';
...
class Explore extends Component {
  ...
  handleSearchFocus(status) {
    ...
    const isEditing = searchFocus && searchString;
		...
		return(
			<Block flex={0.6} style={styles.search}>
				<Input
					placeholder="Search"
	...
	renderImage(img, index) {
		...
		renderExplore() {
			const { images, navigaiton }  = this.props;
	...
	render()
	{
		return(
        	...
        	<ScrollView showVerticalScrollIndicator={false} style={styles.explore}>
        		{this.renderExplore()}
        	</ScrollView>
